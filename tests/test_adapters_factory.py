...
class TestAdaptersFactory:
    ...
    def test_factory_lists_available_adapters(self):
    ...
    def test_check_dependencies_handles_unknown(self):
        """Test check_dependencies handles unknown adapter types."""
        res = check_dependencies("unknown")
        assert res["available"] is False

    def test_recommended_adapter_works_with_dependencies_mock(self, monkeypatch):
        """Test get_recommended_adapter with dependency mock."""
        def fake_check(dep):
